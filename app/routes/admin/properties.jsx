...
function Properties() {
  ...
  return (
    <>
      ...
      <div className="row">
        <div className="col-md-12 col-lg-12 d-flex justify-content-between mb-4">
        ...
        {properties.length > 0 ? (
          <>
            {properties.map((property) => (
              <div className="col-lg-12 col-xl-6" key={property.id}>
            ...
            <div className="col-lg-12 col-xl-12 d-flex justify-content-center mt-3">
              <Pagination
                prev
                last
                next
