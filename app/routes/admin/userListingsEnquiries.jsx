  ...
  return (
    <div className="container-fluid px-0">
      <div className="d-flex justify-content-between align-items-center mb-2">
        <h2 className="mb-0 text-lg font-weight-bold">
              ...
              <div className="card-body py-3 px-4">
                <div className="d-flex justify-content-between align-items-center mb-2">
                  ...
                  <div className="text-right">
                    ...
                    <p className="mt-1 m-0 text-muted small">
                ...
                <div className="row">
                  <div className="col-lg-6 mb-1">
                    <p className="font-weight-bold">
                      Name:{' '}
                      <span className="font-weight-normal">{enquiry.name}</span>
                    </p>
                  </div>
                  <div className="col-lg-6 mb-1">
                    <p className="font-weight-bold">
                      Email:{' '}
                      <span className="font-weight-normal text-md">
                        {enquiry.email}
                      </span>
                    </p>
                  </div>
                  ...
                  <div className="col-12 mb-2">
                    <p className="mb-1">{enquiry.message}</p>
                  </div>
                </div>
              </div>
            </div>
